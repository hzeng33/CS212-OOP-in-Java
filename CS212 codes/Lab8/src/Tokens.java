...
public class Tokens {
    ...
    * countTokens() returns the number of tokens in the string (in this case, 7).
    */
    ...
    */
      ...
      while (myTokens.hasMoreTokens()) {
         animals[i]=myTokens.nextToken(); //The method nextToken() returns the next token stored in the StringTokenizer.
         i++;
      }
    /*
     * Print the array
